package br.com.luanadev.ceepapplication.data.source
...
import br.com.luanadev.ceepapplication.util.wrapEspressoIdlingResource
...
class DefaultTasksRepository(
    ...
    override suspend fun completeTask(taskId: String) {
        withContext(ioDispatcher) {
            (getTaskWithId(taskId) as? br.com.luanadev.ceepapplication.data.Result.Success)?.let { it ->
